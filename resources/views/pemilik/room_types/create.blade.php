...
<div style="max-width: 800px; margin: 0 auto; padding: 24px 0;">
    <div class="page-header">
        <div>
            <h1><i class="bi bi-plus-circle" style="margin-right: 12px;"></i>Buat Tipe Kamar</h1>
            <p>Untuk kos: <strong>{{ $kos->nama }}</strong></p>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <form action="{{ route('pemilik.room_types.store') }}" method="POST" class="form-content">
            @csrf
            <input type="hidden" name="kos_id" value="{{ $kos->id }}">

            <div class="form-group">
                <label for="kos_id">Pilih Kos (jika ingin mengubah)</label>
                <select name="kos_id" id="kos_id" class="form-select-custom">
